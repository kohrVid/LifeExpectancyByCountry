...
options = { 
  1 => { step1: ["List the available countries", LifeExpectancyByCountry.list_of_countries]},
  2 => { step1: ["Find the sum of all records on file", LifeExpectancyByCountry.total_records]},
  ...
  7 => { step1: ["Find the demographic and year with the highest life expectancy", LifeExpectancyByCountry.highest_life_expectancy_group]},
  8 => { step1: ["Find the demographic and year with the lowest life expectancy", LifeExpectancyByCountry.lowest_life_expectancy_group]},
  ...
  15=>{ step1: ["Find the international mean life expectancy", LifeExpectancyByCountry.global_mean]},
  16=>{ step1: ["Find the international median life expectancy", LifeExpectancyByCountry.global_median]},
  ...
  19=>{ step1: ["View the gaps in the collected data", LifeExpectancyByCountry.nil_records]}
}
